...
class AuthorMatchingTests(unittest.TestCase):
    ...
    def test_initials_and_same_last_name_match(self):
        self.assertGreater(score_author_match("Yann LeCun", "Y. LeCun"), 0.0)
    ...
    def test_match_followed_authors_returns_best_match(self):
        matches = match_followed_authors(["Yann Lecunn"], ["Alice Example", "Y. LeCun"])
        self.assertEqual(matches[0]["paper_author"], "Y. LeCun")
